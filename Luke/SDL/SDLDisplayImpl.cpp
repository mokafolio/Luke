...
namespace luke
{
    namespace detail
    {
        ...
        {
            return Error(ec::Unsupported, "SDL only allows you to change the display mode when entering fullscreen with a window", STICK_FILE, STICK_LINE);
        }
        ...
        static DisplayMode fromSDLDisplaymode(SDL_DisplayMode & _mode)
        {
            ...
            if (_mode.format == SDL_PIXELFORMAT_RGB444 ||
                    _mode.format == SDL_PIXELFORMAT_ARGB4444 ||
                    _mode.format == SDL_PIXELFORMAT_RGBA4444 ||
                    _mode.format == SDL_PIXELFORMAT_ABGR4444 ||
                    _mode.format == SDL_PIXELFORMAT_BGRA4444)
            {
                redBits = greenBits = blueBits = 4;
            }
            else if (_mode.format == SDL_PIXELFORMAT_RGB24 ||
                     _mode.format == SDL_PIXELFORMAT_BGR24 ||
                     _mode.format == SDL_PIXELFORMAT_RGB888 ||
                     _mode.format == SDL_PIXELFORMAT_RGBX8888 ||
                     _mode.format == SDL_PIXELFORMAT_BGRX8888 ||
                     _mode.format == SDL_PIXELFORMAT_ARGB8888 ||
                     _mode.format == SDL_PIXELFORMAT_RGBA8888 ||
                     _mode.format == SDL_PIXELFORMAT_ABGR8888 ||
                     _mode.format == SDL_PIXELFORMAT_BGRA8888 ||
                     _mode.format == SDL_PIXELFORMAT_RGBA32 ||
                     _mode.format == SDL_PIXELFORMAT_ARGB32 ||
                     _mode.format == SDL_PIXELFORMAT_BGRA32 ||
