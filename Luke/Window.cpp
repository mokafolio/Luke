...
Window::Window() : m_pimpl(makeUnique<detail::WindowImpl>(defaultAllocator(), this))
{
}
...
Error Window::enterFullscreen(Float32 _width, Float32 _height, const Display & _display)
{
    ...
    if (_display.isValid())
    {
        ...
        mode = _display.findBestDisplayMode(_width,
                                            _height,
                                            current.redBits(),
                                            current.greenBits(),
                                            current.blueBits(),
    ...
    else
    {
        ...
        mode = display().findBestDisplayMode(_width,
                                             _height,
                                             current.redBits(),
                                             current.greenBits(),
                                             current.blueBits(),
